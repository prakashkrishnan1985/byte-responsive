...
import "./styles/LocalLeadCaptureScreen.css";
import Orb from "./LocalOrbBackground";
import Typewriter from "typewriter-effect";
import axios from "axios";
import * as faceapi from "@vladmandic/face-api";
import MicListener from "./LocalMicListener";
import RAGQuestScreen from "./LocalRAGQuestScreen";
import "./styles/LocalRAGQuestScreen.css";
import { sendQuery, processAudio } from "./local-api";
...
const LocalLeadCaptureScreen = ({ onNext }) => {
        ...
        <div className="text-column">
          ...
          <div className="quest-completed-message">
            ...
            <p>
              ...
              {leadInfo.name}! Log in to https://bytesized.com.au/beta to enroll
              in our beta program.
            </p>
          </div>
      ...
      <div className="text-column">
        ...
        {showDemoMessage && (
          <div className="demo-message-container">
            <div className="demo-message">{demoMessage}</div>
          </div>
        )}
              ...
              <>
                      ...
                      <div className="speech-input-container">
                        ...
                        <div className="transcript-display">
                          {isListening ? (
                            ...
                            <p>
                              {currentTranscript || "Please speak your name..."}
                            </p>
                          )}
                        </div>
                      </div>
                ...
                {personalizedQuestion.type === "email" && (
                  <>
                    ...
                    <button className="next-button" onClick={handleInputSubmit}>
                      Next →
                    </button>
                  </>
                )}
...
export default LocalLeadCaptureScreen;
