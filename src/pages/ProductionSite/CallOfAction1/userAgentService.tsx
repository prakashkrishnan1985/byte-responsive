// api.ts
import axiosConfig from '../../../services/axiosConfig'; // Import the axios instance
...
export type PayloadPostInquiry = {
  name: string;
  email: string;
  profession: string;
...
export const postInquiry = async (payload: PayloadPostInquiry) => {
  try {
