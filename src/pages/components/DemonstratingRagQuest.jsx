...
const acts = [
  ...
  {
    title: "ACT 3",
    desc: "Builds vector embeddings from documents so they can be searched semantically.",
    button: "Embedding Engine",
  },
  {
    title: "ACT 4",
    desc: "Retrieves the best matching content with embeddings and crafts a grounded answer using an LLM.",
    button: "LLM",
  },
];
...
export default DemonstratingRagQuest;
