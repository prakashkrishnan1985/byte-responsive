...
def query_ollama(image_path, model="llava:7b-v1.6-mistral-q4_1", prompt="Please give a friendly welcome message to the person in this image. Mention something about what they are wearing or their appearance."):
    # Ollama API endpoint
